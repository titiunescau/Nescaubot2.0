		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('5598991051582@s.whatsapp.net', options, text, {quoted: mek})
...
// recursos anime, random @Nescau domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT Nescauzin ✨* 」\n*│+ wa.me/559887053394*╰──────*「 *Nescauzin* 」*────*\n\n*_SE QUER SER ADMIN DO BOT Nescauzin_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
        ...
        case 'promover':
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Você pra quer adicionar uma egrilo ?')
				...
				default:
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[ERROR]','red'), 'krai menor comando não registrado de', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
			console.log('Error : %s', color(e, 'red'))
