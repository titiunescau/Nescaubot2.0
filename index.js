...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Nescau\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=559887953394:+55 98 87054394\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '*'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD NESCAUZIN BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Nescau. Registre-se para fazer amizade com o bot ✞︎NESCAU✞︎ por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar ✞︎NESCAU✞︎|17\n\n──「 BOT MAN 」──`,
			...
			const ownerNumber = ["559887053394@s.whatsapp.net","559887572412@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559887053394@s.whatsapp.net","559887572412@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559887953394@s.whatsapp.net","559887053394@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559887053394@s.whatsapp.net","559887053394@s.whatsapp.net"]//ubah nomor lo
			const premium = ["559887053394@s.whatsapp.net","559887572412@s.whatsapp.net","12508006253@s.whatsapp.net","19734890640@s.whatsapp.net","556493291604@s.whatsapp.net"]
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("vsfd")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:false})
	}
...
// recursos anime, random @✞︎𝙼𝚎𝚕𝚒𝚘𝚍𝚊𝚜✞︎ domina vida
          ...
          reply('Espere..')
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do ✞︎Nescau✞︎:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
        ...
        case 'promover':
				...
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Você quer pra adicionar uma egrilo?')
				...
				case 'clonar':
					...
					try {
						...
						reply('Pqp, deu erro, a pessoa deve estar sem foto 😔')
					}
					break
		        case 'setfoto2':
                    if (!isGroup) return reply(mess.only.group)
